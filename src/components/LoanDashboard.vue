<template>
  <div>
    ...
    <div class="container-fluid mt-4 px-5">
      <div class="row loan-details-table">
        <b-table striped hover bordered responsive  :items="results" :fields="fields"></b-table>
...
export default {
  data() {
    return {
        results:'',
        fields: ['name', 'loan_amount', 'monthly_payment','mobile_number','email_id']
    };
  },
  mounted() {
    this.getData();
  ...
  methods: {
    getData() {
      debugger;
      let myLoanData = JSON.parse(localStorage.getItem("getData"));
      this.results = myLoanData;
    },
    signOut() {
